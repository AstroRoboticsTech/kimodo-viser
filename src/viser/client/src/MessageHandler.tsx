...
import { normalizeTimelineMessage } from "./timeline/normalize";
import {
  FileTransferPart,
...
function useMessageHandler() {
  ...
  return (message: Message) => {
    ...
    switch (message.type) {
      ...
      // Enable/disable keyboard event listening.
      case "KeyboardListenMessage": {
        viewer.keyboardListenEnabled.current = message.enable;
        return;
      }
      
      // Enable/disable camera keyboard controls.
      case "CameraKeyboardControlsMessage": {
        viewer.cameraKeyboardControlsEnabled.setValue(message.enable);
        return;
      }
      ...
      case "SetSceneNodeClickableMessage": {
        return {
          ...
          updates: {
            ...
            highlight_group: message.highlight_group ?? undefined,
          },
        };
      }

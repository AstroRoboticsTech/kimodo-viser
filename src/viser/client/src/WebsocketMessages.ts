...
export interface TransformControlsMessage {
  ...
  name: string;
  props: {'scale': number, 'line_width': number, 'fixed': boolean, 'active_axes': [boolean, boolean, boolean], 'disable_axes': boolean, 'disable_sliders': boolean, 'disable_rotations': boolean, 'translation_limits': [[number, number], [number, number], [number, number]], 'rotation_limits': [[number, number], [number, number], [number, number]], 'depth_test': boolean, 'opacity': number, 'space': 'world' | 'local'};
}
 ...
 * (automatically generated)
 */
export interface KeyboardListenMessage {
  type: "KeyboardListenMessage";
  enable: boolean;
}
 ...
 * (automatically generated)
 */
export interface CameraKeyboardControlsMessage {
...
/** GuiModalMessage(order: 'float', uuid: 'str', title: 'str', save_choice: 'str | None' = None, size: 'str | None' = None, show_close_button: 'bool' = False)
 *
 * (automatically generated)
 */
 ...
 * (automatically generated)
 */
export interface GuiCloseModalRequestMessage {
...
export interface ThemeConfigurationMessage {
  ...
  titlebar_content: ({'buttons': ({'text': (string | null), 'icon': ('GitHub' | 'Description' | 'Keyboard' | null), 'href': (string | null)}[] | null), 'image': ({'image_url_light': string, 'image_url_dark': (string | null), 'image_alt': string, 'href': (string | null)} | null), 'title_text'?: string} | null);
  ...
  titlebar_dark_mode_checkbox_uuid: (string | null);
}
...
export interface TimelineMessage {
  ...
  prompts: {'uuid': string, 'text': string, 'start_frame': number, 'end_frame': number, 'color': ([number, number, number] | null)}[];
  tracks: {'uuid': string, 'name': string, 'track_type': string, 'color': ([number, number, number] | null), 'height_scale': number}[];
  keyframes: {'uuid': string, 'track_id': string, 'frame': number, 'value': (number | null), 'opacity': number, 'locked': boolean}[];
  intervals: {'uuid': string, 'track_id': string, 'start_frame': number, 'end_frame': number, 'value': (number | null), 'opacity': number, 'locked': boolean}[];
  mode: string;
  constraints_enabled: boolean;
  default_text: string;
  default_duration: number;
  min_prompt_duration: number;
  max_prompt_duration: (number | null);
  default_num_frames_zoom: number;
  max_frames_zoom: number;
}
/** Message from client->server when timeline interaction occurs.
 *
 * (automatically generated)
 */
export interface TimelineUpdateMessage {
 ...
 * (automatically generated)
 */
export interface ArrowKeyOverlayMessage {
  type: "ArrowKeyOverlayMessage";
  enabled: boolean;
  highlighted: 'ArrowUp' | 'ArrowDown' | 'ArrowLeft' | 'ArrowRight'[];
  base_opacity: number;
  highlight_opacity: number;
  position: 'bottom_left' | 'bottom_center' | 'bottom_right' | 'top_center' | 'top_right';
}
/** Message from client->server to add a keyframe.
 *
 * (automatically generated)
 */
export interface TimelineKeyframeAddMessage {
 ...
 * (automatically generated)
 */
export interface TimelineKeyframeMoveMessage {
 ...
 * (automatically generated)
 */
export interface TimelineKeyframeDeleteMessage {
 ...
 * (automatically generated)
 */
export interface TimelineIntervalAddMessage {
 ...
 * (automatically generated)
 */
export interface TimelineIntervalMoveMessage {
 ...
 * (automatically generated)
 */
export interface TimelineIntervalDeleteMessage {
 ...
 * (automatically generated)
 */
export interface TimelinePromptUpdateMessage {
 ...
 * (automatically generated)
 */
export interface TimelinePromptResizeMessage {
 ...
 * (automatically generated)
 */
export interface TimelinePromptMoveMessage {
 ...
 * (automatically generated)
 */
export interface TimelinePromptSwapMessage {
  type: "TimelinePromptSwapMessage";
  prompt_id_1: string;
  prompt_id_2: string;
}
 ...
 * (automatically generated)
 */
export interface TimelinePromptDeleteMessage {
 ...
 * (automatically generated)
 */
export interface TimelinePromptAddMessage {
 ...
 * (automatically generated)
 */
export interface TimelinePromptSplitMessage {
 ...
 * (automatically generated)
 */
export interface TimelinePromptMergeMessage {
  type: "TimelinePromptMergeMessage";
  prompt_id_left: string;
...
export type Message = 
  ...
  | TimelineKeyframeAddMessage
  | TimelineKeyframeMoveMessage
  | TimelineKeyframeDeleteMessage
  | TimelineIntervalAddMessage
  | TimelineIntervalMoveMessage
  | TimelineIntervalDeleteMessage
  | TimelinePromptUpdateMessage
  | TimelinePromptResizeMessage
  | TimelinePromptMoveMessage
  | TimelinePromptSwapMessage
  | TimelinePromptDeleteMessage
  | TimelinePromptAddMessage
  | TimelinePromptSplitMessage
  | TimelinePromptMergeMessage;
